...
namespace ssio
{
    ...
    client_impl::~client_impl()
    {
        this->sockets_invoke_void(&ssio::socket::on_close);
        sync_close();
    }
    ...
    socket::ptr const& client_impl::socket(string const& nsp)
    {
        ...
        {
            pair<const string, socket::ptr> p(aux,shared_ptr<ssio::socket>(new ssio::socket(this,aux)));
    ...
    void client_impl::close()
    {
        ...
        this->sockets_invoke_void(&ssio::socket::close);
    ...
    void client_impl::sockets_invoke_void(void (ssio::socket::*fn)(void))
    {
    ...
    void client_impl::on_fail(connection_hdl con)
    {
        m_con.reset();
        m_con_state = con_closed;
        this->sockets_invoke_void(&ssio::socket::on_disconnect);
    ...
    void client_impl::on_open(connection_hdl con)
    {
        ...
        m_con = con;
        m_reconn_made = 0;
        this->sockets_invoke_void(&ssio::socket::on_open);
        this->socket("");
...
failed:
    ...
    client_impl::context_ptr client_impl::on_tls_init(connection_hdl conn)
    {
		...
		ctx->set_options(boost::asio::ssl::context::default_workarounds |
			boost::asio::ssl::context::no_sslv3 | boost::asio::ssl::context::no_tlsv1_1 |
